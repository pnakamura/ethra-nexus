...
vi.mock('@ethra-nexus/db', () => ({
  getDb: () => mockDb,
  files: { id: 'id', tenant_id: 'tenant_id', storage_key: 'storage_key', mime_type: 'mime_type', size_bytes: 'size_bytes', sha256: 'sha256', original_filename: 'original_filename', uploaded_by: 'uploaded_by', expires_at: 'expires_at' },
